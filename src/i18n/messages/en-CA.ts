...
export const English: Messages = {
  ...
  help1: `
  you probably know what globle is and how to play it but if you don't:
  every time you refresh, there is a new Mystery Country. Your goal is to guess the
  ...
  q4: "4. how do i play again in globle unlimited?",
  a4: "you can play again in globle Unlimited by refreshing or by clicking the play again button in the header.",
